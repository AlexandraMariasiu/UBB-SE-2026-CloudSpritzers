# ✈️ CloudSpritzers | Airport Customer Service App

**CloudSpritzers** is a **WinUI 3** modern Windows desktop application powered by **.NET**. It utilizes the **MVVM architecture** to deliver a responsive and robust interface for airport customer service.
