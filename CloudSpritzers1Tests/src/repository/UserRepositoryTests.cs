...
namespace CloudSpritzers1Tests.src.repository
{
    ...
    public class UserRepositoryTests
    {
        ...
        public void GetById_ExistingUser_ReturnsCorrectUser()
        {
            ...
            _userRepository.CreateReview(user);
        ...
        {
            Assert.ThrowsExactly<ArgumentNullException>(() => _userRepository!.CreateReview(null!));
        }

        [TestMethod]
        public void GetAll_ReturnsAllUsers()
        {
            _userRepository.CreateReview(new User(1, "User1", "u1@test.com"));
            _userRepository.CreateReview(new User(2, "User2", "u2@test.com"));
