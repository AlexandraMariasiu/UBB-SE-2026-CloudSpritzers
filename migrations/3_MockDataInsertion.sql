...
('Alice Smith', 'alice@airport.com', 'Technical Support'),
('Bob Jones', 'bob@airport.com', 'Refunds & Billing'),
('Charlie Brown', 'charlie@airport.com', 'Flight Operations');
...
(0, 'Carlos', 'customer-support@cloudspritzers.com', 'A.R.S.');
SET IDENTITY_INSERT Employee OFF;

INSERT INTO TicketCategory ([name]) VALUES ('Baggage'), ('Flight Change'), ('Refunds'), ('Duty Free');

INSERT INTO TicketSubcategory ([name], category_id) VALUES 
('Lost Suitcase', 1), 
('Damaged Item', 1),
('Date Change', 2),
('Full Refund Request', 3),
('Sephora', 4),
('Animax', 4),
('Kaufland', 4),
('Carturesti', 4),
...
(2, 'Low', 'Closed', 'Stumbeled on red carpet', 'Fell due to the carpet layed at the entrance.', 4, 5, GETDATE(), 1),
(3, 'Medium', 'Open', 'Flight RO123 got delayed.', 'It is unacceptable that you can not control the weather.', 2, 2, GETDATE(), 1);
...
VALUES ('What is the liquid limit?', 'The limit is 100ml per container.', 'Security', 150, 45),
('How big can my carry-on luggage be?', 'The limit for the luggage depends on the ticket bought and the flight provider.', 'Flights', 200, 30),
('How early should I arrive at the airport?', 'We recommend arriving at least 3 hours before international flights and 2 hours for domestic flights.', 'General', 450, 120),
('Can I bring my pet on the flight?', 'Pet policies vary by airline. Generally, small pets can travel in the cabin in a carrier, while larger ones must go in the cargo hold.', 'Pets', 85, 20),
('Where is the lost and found office?', 'The lost and found office is located on the ground floor of Terminal B, near the arrivals exit.', 'Services', 310, 88),
('Do you have free Wi-Fi?', 'Yes, select "Airport_Free_WiFi" from your settings. No password is required.', 'Amenities', 900, 450  ),
('What items are prohibited in checked baggage?', 'Explosives, flammable liquids, and loose lithium batteries are strictly prohibited.', 'Security', 125, 60),
('Is there a prayer room in the airport?', 'Yes, multi-faith prayer rooms are located in Terminals A and C after security.', 'Services', 45, 15);
